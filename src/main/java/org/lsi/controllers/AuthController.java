...
public class AuthController {
    ...
    public List<User> getAllAdmins() {
		...
		/*
		 * List<User> admins = new ArrayList<User>(); Set<Role> strRoles =
		 * users.getRoles(); for (User user : users) { //Role userRole = (Role)
		 * user.getRoles(); if (strRoles = ["admin"]) { admins.add(user); } }
		 * 
		 * find user by role (userRole)
		 */
